...
function actionFormatter(value, row, index) {
	var html = "<button class='btn btn-primary' type='button' onclick='make(\""+row.id+"\")'><i class='fa fa-search'></i>详情</button>"	
	+"<button class='btn btn-primary' type='button' onclick='push(\""+row.id+"\")'><i class='fa fa-search'></i>审核</button>"
	+"<button class='btn btn-primary' type='button' onclick='cancel(\""+row.id+"\")'><i class='fa fa-search'></i>作废</button>";
    return html;
}
...
function detail(id){
	parent.window.jsOpeanIntoPieceDetail(id,"/loan/contractmaking");
}

function make(id){
	var url = "/loan/basicloan?id="+id;
