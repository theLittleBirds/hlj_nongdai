...
function actionFormatter(value, row, index) {
	var html = "<button class='btn btn-primary' type='button' onclick='onLinePay(\""+row.id+"\")'><i class='fa fa-search'></i>线上支付</button><button class='btn btn-primary' type='button' onclick='underLinePay(\""+row.id+"\")'><i class='fa fa-search'></i>线下支付</button>";
    return html;
}
...
function underLinePay(id){
	var url = "/union/underlinepay?intoPieceId="+id;
