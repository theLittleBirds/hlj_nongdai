...
<head>
    ...
    <title>安家世行</title>
    <meta name="keywords" content="安家世行">
	<meta name="description" content="">

	<link rel="shortcut icon" href="/admin/image/anjiafavicon.ico">
	<!-- Bootstrap -->
	<link href="/resource/bootstrap/css/bootstrap.min.css" rel="stylesheet">
	<link href="/admin/css/anjialogin.css" rel="stylesheet">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-4 panel panel-default div">
				...
				<img src="/admin/image/anjialoginlogo.png" style="width:80%"/>
			...
			<div style="position: absolute; bottom: 50px; right:10%; text-align: center;">
				<img src="/admin/image/anjialogo.png" style="width:80%"/>
