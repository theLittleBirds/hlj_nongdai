...
<head>
    ...
    <title>首信</title>
    <meta name="keywords" content="首信">
	<meta name="description" content="">

	<link rel="shortcut icon" href="/admin/image/shouxinfavicon.ico">
	<!-- Bootstrap -->
	<link href="/resource/bootstrap/css/bootstrap.min.css" rel="stylesheet">
	<link href="/admin/css/shouxinlogin.css" rel="stylesheet">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-sm-4 panel panel-default div">
				<div class="margin-base-vertical center" style="font-size:20px;height:100px;line-height:22px;overflow:hidden;">
				<img src="/admin/image/shouxinloginlogo.png" style="width:80%"/>
			...
			<div style="position: absolute; bottom: 50px; right:10%; text-align: center;">
				<img src="/admin/image/shouxinlogo.png" style="width:80%"/>
