                                    ...
                                    <div class="form-inline">
									 ...
									 <div class="form-group">
									  ...
									  <div class="form-group">
                                        ...
                                        <button class="btn btn-primary" type="button" onclick="batchExamine()"><i class="fa fa-search"></i> 批量审核
                                        </button>
									</div>
                                </div>
                            </div>
...
function actionFormatter(value, row, index) {
	var html = "<button class='btn btn-primary' type='button' onclick='detail(\""+row.id+"\")'><i class='fa fa-search'></i>详情</button><button class='btn btn-primary' type='button' onclick='examine(\""+row.id+"\")'><i class='fa fa-search'></i>审核</button>";
    return html;
}
...
function detail(id){
	parent.window.jsOpeanIntoPieceDetail(id,"/examine/last");
}

function examine(id){
	var url = "/examine/lastform?intoPieceId="+id;
...
function batchExamine(){
	...
	if(selections.length>0){
		...
		parent.window.bootbox.alert("请选择批量审核的进件");
	}
}
</script>
</body>
