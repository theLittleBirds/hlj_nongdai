...
(function (w, i) {
    ...
    function m(a, b) {
        if (Z(a))for (var c = 0, d = a.length; c < d; c++) {
    ...
    function u(a, b) {
        var b = b === i ? "," : b, c = {}, d = Z(a) ? a : a.split(b), e;
        m(d, function (a, b) {
    ...
    function ia(a, b, c, d) {
        ...
        if (d === i)var h = location.pathname.match(/^(\/.*)\//), d = h ? h[1] : "";
        var f;
        if (f = /^(\w+:\/\/[^\/]*)/.exec(a)) {
            if (f[1] !== c)return a
    ...
    function U(a, b, c, d, e) {
        a == null && (a = "");
        var c = c || "", d = l(d, !1), e = l(e, "\t"), g = "xx-small,x-small,small,medium,large,x-large,xx-large".split(","), a = a.replace(/(<(?:pre|pre\s[^>]*)>)([\s\S]*?)(<\/pre>)/ig, function (a, b, c, d) {
        ...
        var f = [], a = a.replace(/(\s*)<(\/)?([\w\-:]+)((?:\s+|(?:\s+[\w\-:]+)|(?:\s+[\w\-:]+=[^\s"'<>]+)|(?:\s+[\w\-:"]+="[^"]*")|(?:\s+[\w\-:"]+='[^']*'))*)(\/)?>(\s*)/g,
            function (a, n, q, r, K, ja, i) {
                var n = n || "", q = q || "", l = r.toLowerCase(), o = K || "", r = ja ? " " + ja : "", i = i || "";
                if (b && !h[l])return "";
                r === "" && kb[l] && (r = " /");
                lb[l] && (n && (n = " "), i && (i = " "));
                La[l] && (q ? i = "\n" : n = "\n");
    ...
    function qb(a, b) {
        var c = b.width, d = b.height, e = b.type || ob(b.src), g = Ma(b), h = "";
    ...
    function Ca(a, b) {
        ...
        function g(a, b, c) {
            var e = c.ownerDocument || c, g = [], h, f, j;
        ...
        function f(a, b) {
            var c = [], j, k = (j = /^((?:\\.|[^.#\s\[<>])+)/.exec(a)) ? j[1] : "*";
            if (j = /#((?:[\w\-]|\\.)+)$/.exec(a))c =
                e(j[1], k, b); else if (j = /\.((?:[\w\-]|\\.)+)$/.exec(a))c = g(j[1], k, b); else if (j = /\[((?:[\w\-]|\\.)+)\]/.exec(a))c = h(j[1].toLowerCase(), null, k, b); else if (j = /\[((?:[\w\-]|\\.)+)\s*=\s*['"]?((?:\\.|[^'"]+)+)['"]?\]/.exec(a)) {
                c = j[1].toLowerCase();
                j = j[2];
                if (c === "id")k = e(j, k, b); else if (c === "class")k = g(j, k, b); else if (c === "name") {
                    c = [];
        ...
        var r = !1, K, l, i, o, p, z, L, F, s, t;
        z = 0;
        for (lenth = k.length; z < lenth; z++)if (K = k[z], K === ">")r = !0; else {
            if (z > 0) {
                l = [];
                L = 0;
    ...
    function Qa(a, b, c) {
        ...
        function g(e, l) {
            for (var i = e.firstChild, o; i;) {
                ...
                if (m >= 0)return !1;
                o = i.nextSibling;
                if (n > 0)if (i.nodeType == 1)if (q >= 0 && r <= 0)b && l.appendChild(i.cloneNode(!0)), c && f.push(i); else {
                    var p;
        ...
        var h = a.doc, f = [], k = a.cloneRange().down(), n = -1, q = -1, r = -1, m = -1, l = a.commonAncestor(), i = h.createDocumentFragment();
    ...
    function sb(a, b) {
        ...
        var h = c, j = 0, k = -1, n = a.duplicate();
        na(n, e);
        for (var q = 0, r = g.length; q < r; q++) {
            var i = g[q], k = n.compareEndPoints("StartToStart", d);
            if (k === 0)return {node: i.parentNode, offset: q};
            if (i.nodeType ==
                1) {
                var l = a.duplicate(), m, o = f(i), p = i;
    ...
    function Wa(a) {
        ...
        d.mousedown(function (a) {
            function j(a) {
                a.preventDefault();
                var b = f(V(a.target)), e = R((b.data("pos-x") || 0) + a.pageX - p), a = R((b.data("pos-y") || 0) + a.pageY - s);
    ...
    function bb(a, b) {
        var c = document.getElementsByTagName("head")[0] || (P ? document.body : document.documentElement), d = document.createElement("script");
        c.appendChild(d);
        d.src = a;
        d.charset = "utf-8";
    ...
    function cb(a) {
        for (var b =
            document.getElementsByTagName("head")[0] || (P ? document.body : document.documentElement), c = document.createElement("link"), d = Fb(ia(a, "absolute")), e = f('link[rel="stylesheet"]', b), g = 0, h = e.length; g < h; g++)if (Fb(ia(e[g].href, "absolute")) === d)return;
        b.appendChild(c);
        c.href = a;
        c.rel = "stylesheet"
    }
        ...
        f(a.edit.doc).contextmenu(function (b) {
            ...
            if (a.useContextmenu) {
                if (a._contextmenus.length !== 0) {
                    ...
                    if (d.length > 0) {
                        b.preventDefault();
                        var g = f(a.edit.iframe).pos(), h = $a({x: g.x + b.clientX, y: g.y + b.clientY, width: c, css: {visibility: "hidden"}, shadowMode: a.shadowMode});
                        m(d, function () {
                            this.title &&
                            h.addItem(this)
                        });
                        var g = G(h.doc), j = h.div.height();
        ...
        if (!(o && d !== "br") && (!Y || !(A < 3 && d !== "p")) && !(Pa && A < 9)) {
            ...
            f(c).keyup(function (e) {
                if (!(e.which != 13 || e.shiftKey || e.ctrlKey || e.altKey) && d != "br")if (Y) {
                    var e = b.cmd.commonAncestor("p"), j = b.cmd.commonAncestor("a");
                    j && j.text() == "" && (j.remove(!0), b.cmd.range.selectNodeContents(e[0]).collapse(!0), b.cmd.select())
                } else if (b.cmd.selection(), e = a(b.cmd.range),
                        !(e == "marquee" || e == "select"))if (g[e] || Q(c, "formatblock", "<p>"), e = b.cmd.commonAncestor("div")) {
    ...
    if (!w.KindEditor) {
        ...
        var Ha = "4.1.10 (2013-11-23)", p = navigator.userAgent.toLowerCase(), o = p.indexOf("msie") > -1 && p.indexOf("opera") == -1, Yb = p.indexOf("msie") == -1 && p.indexOf("trident") > -1, Y = p.indexOf("gecko") > -1 && p.indexOf("khtml") == -1, X = p.indexOf("applewebkit") > -1, Pa = p.indexOf("opera") > -1, ec = p.indexOf("mobile") > -1, fc = /ipad|iphone|ipod/.test(p), P = document.compatMode != "CSS1Compat", H = !w.getSelection, A = (p = /(?:msie|firefox|webkit|opera)[\/:\s](\d+)/.exec(p)) ? p[1] : "0", Ga = (new Date).getTime(), R = Math.round, f = {
                DEBUG: !1, VERSION: Ha, IE: o, GECKO: Y, WEBKIT: X, OPERA: Pa, V: A, TIME: Ga, each: m, isArray: Z, isFunction: wa, inArray: J, inString: xa, trim: B, addUnit: s,
                removeUnit: t, escape: C, unescape: fa, toCamel: ga, toHex: ya, toMap: u, toArray: Ja, undef: l, invalidUrl: function (a) {
                    return !a || /[<>"]/.test(a)
                }, addParam: function (a, b) {
                    return a.indexOf("?") >= 0 ? a + "&" + b : a + "?" + b
                }, extend: E, json: eb
            }, lb = u("a,abbr,acronym,b,basefont,bdo,big,br,button,cite,code,del,dfn,em,font,i,img,input,ins,kbd,label,map,q,s,samp,select,small,span,strike,strong,sub,sup,textarea,tt,u,var"), mb = u("address,applet,blockquote,body,center,dd,dir,div,dl,dt,fieldset,form,frameset,h1,h2,h3,h4,h5,h6,head,hr,html,iframe,ins,isindex,li,map,menu,meta,noframes,noscript,object,ol,p,pre,script,style,table,tbody,td,tfoot,th,thead,title,tr,ul"),
            kb = u("area,base,basefont,br,col,frame,hr,img,input,isindex,link,meta,param,embed"), Mb = u("b,basefont,big,del,em,font,i,s,small,span,strike,strong,sub,sup,u"), gc = u("img,table,input,textarea,button"), La = u("pre,style,script"), Ia = u("html,head,body,td,tr,table,ol,ul,li");
        u("colgroup,dd,dt,li,options,p,td,tfoot,th,thead,tr");
        var Ub = u("checked,compact,declare,defer,disabled,ismap,multiple,nohref,noresize,noshade,nowrap,readonly,selected"), Nb = u("input,button,textarea,select");
        f.basePath = function () {
            for (var a =
        ...
        var fb = !1, Ob = u("8,9,13,32,46,48..57,59,61,65..90,106,109..111,188,190..192,219..222"),
            p = u("33..40"), db = {};
        m(Ob, function (a, b) {
            db[a] = b
        });
        ...
        var $ = "kindeditor_" + Ga, ib = 0, v = {}, Pb = !1;
        ...
        f.ready = function (a) {
            ...
            if (Pb)a(KindEditor); else {
                var e = !1;
                if (document.addEventListener)aa(document, "DOMContentLoaded", b); else if (document.attachEvent) {
        ...
        E(D, {
            ...
            data: function (a, b) {
                ...
                if (a)if (a.getBoundingClientRect)a = a.getBoundingClientRect(), c = ca(this.doc), b = a.left + c.x, c = a.top + c.y; else for (; a;)b += a.offsetLeft, c += a.offsetTop, a = a.offsetParent;
                return {x: R(b), y: R(c)}
            }, clone: function (a) {
        ...
        E(M, {
            init: function (a) {
                ...
                for (var b = a(this.startContainer),
                         c = a(this.endContainer), d = 0, e = b.length, g = c.length, f, j; ++d;)if (f = b[e - d], j = c[g - d], !f || !j || f !== j)break;
                return b[e - d + 1]
                ...
                var b = this.startContainer, c = this.startOffset, d = this.endContainer, e = this.endOffset, g, f, j, k = 1;
        ...
        E(oa, {
            init: function (a) {
                ...
                var a = l(a, !0), b = this.sel, c = this.range.cloneRange().shrink(), d = c.startContainer, e = c.startOffset, g = V(d), h = this.win, j, k = !1;
                ...
                } else k && c.collapse(!1), j = c.get(!0), b.removeAllRanges(), b.addRange(j), g !== document && (c = f(j.endContainer).pos(), h.scrollTo(c.x, c.y));
                h.focus();
                return this
            }, wrap: function (a) {
                var b = this.range, c;
                ...
                f(a).scan(function (a) {
                    if (!g && a == e.start)g = !0; else if (g) {
                        ...
                        if (!d && b.type == 3 && B(a.nodeValue).length > 0) {
                            ...
                            n = c;
                            n = n.clone(!0);
                            if (b.type == 3)Va(n).append(b.clone(!1)), b.replaceWith(n); else {
                                for (var a = b, i; (i = b.first()) && i.children().length == 1;)b = i;
                                i = b.first();
                ...
                if (a === "forecolor")return (a = this.commonNode({"*": ".color"})) && (c = a.css("color")), c = ya(c), c === "" && (c = "default"),
                    c.toLowerCase();
                if (a === "hilitecolor")return (a = this.commonNode({"*": ".background-color"})) && (c = a.css("background-color")), c = ya(c), c === "" && (c = "default"), c.toLowerCase();
                return c
            }, toggle: function (a, b) {
                ...
                var g = e.startContainer, h = e.startOffset, j = e.endContainer, e = e.endOffset;
        ...
        E(S, {
            init: function (a) {
                ...
                var c = t(a) || 0, d = t(b) || 0, e = ca();
                if (this._alignEl) {
                    var g =
                        f(this._alignEl), h = g.pos(), c = R(g[0].clientWidth / 2 - c / 2), d = R(g[0].clientHeight / 2 - d / 2);
                    x = c < 0 ? h.x : h.x + c;
                    y = d < 0 ? h.y : h.y + d
        ...
        E(qa, S, {
            init: function (a) {
                ...
                var d = l(a.themesPath, ""), e = a.bodyClass, g = a.cssPath, h = a.cssData, j = location.protocol != "res:" && location.host.replace(/:\d+/, "") !== document.domain, k = "document.open();" + (j ? 'document.domain="' + document.domain + '";' : "") + "document.close();", k = o ? ' src="javascript:void(function(){' + encodeURIComponent(k) +
                '}())"' : "";
            ...
            init: function (a) {
                ...
                if (a.title === "-")this.div.append(f('<div class="ke-menu-separator"></div>')); else {
                    var b = f('<div class="ke-menu-item" unselectable="on"></div>'),
                        c = f('<div class="ke-inline-block ke-menu-item-left"></div>'), d = f('<div class="ke-inline-block ke-menu-item-right"></div>'), e = s(a.height), g = l(a.iconClass, "");
                    this.div.append(b);
        ...
        E(ab, {
            init: function (a) {
                var b = f(a.button), c = a.fieldName ||
                    "file", d = a.url || "", e = b.val(), g = a.extraParams || {}, h = b[0].className || "", j = a.target || "kindeditor_upload_iframe_" + (new Date).getTime();
                ...
                b.bind("load", function () {
                    ...
                    c.reset();
                    f(c).remove(!0);
                    var c = f.iframeDoc(b), d = c.getElementsByTagName("pre")[0], e = "", g, e = d ? d.innerHTML : c.body.innerHTML, e = fa(e);
        ...
        E(ta, S, {
            init: function (a) {
                ...
                var c = a.title, d = f(a.body, this.doc), e = a.previewBtn, g = a.yesBtn, h = a.noBtn, j = a.closeBtn, k = l(a.showMask, !0);
        ...
        f.dialog = Eb;
        f.tabs = function (a) {
            var b = Ya(a), c = b.remove, d = a.afterSelect, a = b.div, e = [];
        ...
        f.ajax = function (a, b, c, d, e) {
            var c = c || "GET", e = e || "json", g = w.XMLHttpRequest ? new w.XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP");
            g.open(c, a, !0);
        ...
        ua.prototype = {
            lang: function (a) {
                ...
                var h = f(".toolbar", g), j = f(".edit", g), k = b.statusbar = f(".statusbar", g);
                ...
                var h = b.toolbar = Cb({
                    src: h, html: i.join(""), noDisableItems: b.noDisableItems, click: function (a, c) {
                        a.stop();
                        if (b.menu) {
                            var d = b.menu.name;
                            b.hideMenu();
                ...
                }), l = t(e) - h.div.height(), m = b.edit = Ab({
                ...
                c ? (b._fullscreenResizeHandler = function () {
                    ...
                    moveEl: g, clickEl: k.last(), moveFn: function (a, c, d, e, g, f) {
                        d += g;
                        e += f;
                        b.resize(d, e)
                    }
                ...
                var a = a.toLowerCase(), b = this.cmd, c = J(a, "selectall,copy,paste,print".split(",")) < 0;
            ...
            appendHtml: function (a) {
                ...
                var a = l(a, !0), b = this.edit, c = b.doc.body, d = Fa(c.innerHTML);
                ...
                b.designMode && !this._firstAddBookmark ? (b = this.cmd.range, a = b.createBookmark(!0), a.html = Fa(c.innerHTML), b.moveToBookmark(a)) : a = {html: d};
        ...
        Gb("core", function (a) {
            ...
            b.clickToolbar("formatblock", function () {
                var a = b.lang("formatblock.formatBlock"), c = {h1: 28, h2: 24, h3: 18, H4: 14, p: 12}, d = b.cmd.val("formatblock"), f = b.createMenu({
                    name: "formatblock",
                ...
                m(a, function (a, e) {
                    ...
                    f.addItem({
                        title: '<span style="' +
                        i + '" unselectable="on">' + e + "</span>", height: c[a] + 12, checked: d === a || d === e, click: function () {
            ...
            b.clickToolbar("fontsize",
                function () {
                    ...
                    m(b.fontSizeTable, function (d, f) {
                        c.addItem({
                            title: '<span style="font-size:' + f + ';" unselectable="on">' + f + "</span>", height: t(f) + 12, checked: a === f, click: function () {
            ...
            m("forecolor,hilitecolor".split(","), function (a, c) {
                b.clickToolbar(c, function () {
                    b.createMenu({
                        name: c, selectedColor: b.cmd.val(c) || "default", colors: b.colorTable, click: function (a) {
                            b.exec(c, a).hideMenu()
                        }
                    })
                })
            ...
            m("link,image,flash,media,anchor".split(","), function (a, c) {
                ...
                m("edit,delete".split(","), function (a, e) {
                    b.addContextmenu({
                        ...
                        }, cond: b.plugin["getSelected" + d], width: 150, iconClass: e == "edit" ? "ke-icon-" + c : i
                    })
                });
            ...
            b.afterCreate(function () {
                ...
                var d = b.edit.doc, f, j, i, l = "__kindeditor_paste__", m = !1;
                a(d.body).bind("paste", function (p) {
                    if (b.pasteType === 0)p.stop(); else if (!m) {
                        m = !0;
                        a("div." + l, d).remove();
                        f = b.cmd.selection();
                        j = f.range.createBookmark();
                        i = a('<div class="' + l + '"></div>', d).css({
                            position: "absolute", width: "1px", height: "1px", overflow: "hidden", left: "-1981px", top: a(j.start).pos().y +
            ...
            b.beforeGetHtml(function (a) {
                ...
                return a.replace(/(<(?:noscript|noscript\s[^>]*)>)([\s\S]*?)(<\/noscript>)/ig, function (a, b, c, d) {
                    ...
                    var a = I(a), b = ba(a.style || ""), c = pb(a["data-ke-tag"]), d = l(b.width, ""), b = l(b.height, "");
                    /px/i.test(d) && (d = t(d));
                    /px/i.test(b) && (b = t(b));
                    c.width = l(a.width, d);
