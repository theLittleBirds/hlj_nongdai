        ...
        function k(e, n) {
            function h() {
                u-- > 0 ? r(p, 1e3) : (n.loaded = f, e.trigger("Error", {
                    ...
                    message: o.translate("HTTP发生网络错误."),
                    file: n,
        ...
        a = {
            ...
            init: function () {
                ...
                if (!a.browse_button || !a.url) {
                    ...
                    this.trigger("Error", {code: o.INIT_ERROR, message: o.translate("初始化发生错误.")});
                    return
                }
