...
!function (a, b) {
    ...
    return b("dollar-third", [], function () {
        ...
        function b(b) {
            var c, d, e, f, g, h, i = [], j = !b && [], k = function (a) {
        ...
        function c(d) {
            var e = [["resolve", "done", b(!0), "resolved"], ["reject", "fail", b(!0), "rejected"], ["notify", "progress", b()]], f = "pending", g = {
                state: function () {
                    return f
                }, always: function () {
                    ...
                    return c(function (c) {
                        a.each(e, function (d, e) {
                            var f = e[0], i = a.isFunction(b[d]) && b[d];
                            h[e[1]](function () {
                                var b;
        ...
        var d;
        return d = {
            Deferred: c, isPromise: function (a) {
                return a && "function" == typeof a.then
            }, when: function (b) {
                var d, e, f, g = 0, h = [].slice, i = h.call(arguments), j = i.length, k = 1 !== j || b && a.isFunction(b.promise) ? j : 0, l = 1 === k ? b : c(), m = function (a, b, c) {
                    return function (e) {
                        b[a] = this, c[a] = arguments.length > 1 ? h.call(arguments) : e, c === d ? l.notifyWith(b, c) : --k || l.resolveWith(b, c)
                    }
                };
                if (j > 1)for (d = new Array(j), e = new Array(j), f = new Array(j); j > g; g++)i[g] && a.isFunction(i[g].promise) ? i[g].promise().done(m(g, f, i)).fail(l.reject).progress(m(g, e, d)) : --k;
        ...
        return {
            version: "0.1.5", $: b, Deferred: c.Deferred, isPromise: c.isPromise, when: c.when, browser: function (a) {
        ...
        var f = b.$;
        return e.options = {button: null, container: null, label: null, innerHTML: null, multiple: !0, accept: null, name: "file"}, b.inherits(c, {
            constructor: e,
            init: function () {
        ...
        var e = a.$;
        return d.options = {quality: 90, crop: !1, preserveHeaders: !1, allowMagnify: !1}, a.inherits(b, {
        ...
        function e(a, b) {
            ...
            }; h > j;)c = Math.min(b, g - i), e.push({file: a, start: i, end: b ? i + c : g, total: g, chunks: h, chunk: j++, cuted: d}), i += c;
            return a.blocks = e.concat(), a.remaning = e.length, d
        }

        var f = a.$, g = a.isPromise, h = c.Status;
        f.extend(b.options, {prepareNextFile: !1, chunked: !1, chunkSize: 5242880, chunkRetry: 2, threads: 3, formData: {}}), b.register({
            name: "upload", init: function () {
                ...
                }), m = f.extend(m, {id: k.id, name: k.name, type: k.type, lastModifiedDate: k.lastModifiedDate, size: k.size}), b.chunks > 1 && f.extend(m, {
                    chunks: b.chunks,
                    chunk: b.chunk
        ...
        if (h)return d = {dv: 3, master: "webuploader", online: /test/.exec(g) ? 0 : 1, module: "", product: g, type: 0}, b.register({
