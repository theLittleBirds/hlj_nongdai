...
{      
	...
	if(partA>50){ resWordP1="A"}
	else if(partA>=35&&partA<=50){resWordP1="B"}
	else if(partA>=20&&partA<=35){resWordP1="C"}
	else if(partA<20){resWordP1="D"}
	
	var b=borrow();
	partB=b;
	part2.item(0).value=partB;
	
	if(partB>80){ resWordP2="A"}
	else if(partB>=60&&partB<=80){resWordP2="B"}
	else if(partB>=50&&partB<=60){resWordP2="C"}
	else if(partB<50){resWordP2="D"}
	...
	if(partC>80){ resWordP3="A"}
	else if(partC>=70&&partC<=80){resWordP3="B"}
	else if(partC>=60&&partC<=70){resWordP3="C"}
	else if(partC<60){resWordP3="D"}
