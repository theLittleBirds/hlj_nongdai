...
public class NjMerGather {
    ...
    public String getDownTotalprice() {
        return downTotalprice;
    }

    public void setDownTotalprice(String downTotalprice) {
        this.downTotalprice = downTotalprice == null ? null : downTotalprice.trim();
    }
	...
	public String getDownPricetime() {
		return downPricetime;
	}

	public void setDownPricetime(String downPricetime) {
		this.downPricetime = downPricetime;
	}
