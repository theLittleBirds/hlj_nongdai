...
public class BusFins {
    ...
    public String getMgrRoleCode() {
        return mgrRoleCode;
    }

    public void setMgrRoleCode(String mgrRoleCode) {
        this.mgrRoleCode = mgrRoleCode == null ? null : mgrRoleCode.trim();
    }
    ...
    public void setPbcCode(String pbcCode) {
        this.pbcCode = pbcCode == null ? null : pbcCode.trim();
    }
